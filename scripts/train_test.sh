...
--auto_lr_find True --fast_dev_run False --n_channels_in 3 --heatmap_sigma 2 --n_resnet_blocks 3 --n_hourglasses 5 --augment_train --minimal_keypoint_extraction_pixel_distance 10