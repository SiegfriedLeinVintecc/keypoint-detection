...
--max_epochs 16 --early_stopping_relative_threshold -1 --log_every_n_steps 1 --accelerator="gpu" --devices 1 --precision 16 \
--backbone_type "Unet" --learning_rate 0.0004 --maximal_gt_keypoint_pixel_distances "2 4" --ap_epoch_freq 2 \
--auto_lr_find True --fast_dev_run False --n_channels_in 3 --heatmap_sigma 1
# --augment_train
# --auto_lr_find 
