...
--auto_lr_find True --fast_dev_run False --n_channels_in 3 --n_channels 32 --heatmap_sigma 2 --variable_heatmap_sigma 1.2 \
--n_resnet_blocks 3 --n_downsampling_layers 2 --n_hourglasses 2 --n_hg_blocks 4 --augment_train --loss_function "BCE";