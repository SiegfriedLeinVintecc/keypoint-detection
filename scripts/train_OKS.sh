...
--batch_size 8 --json_dataset_img_size "512x512" \
...
--auto_lr_find True --fast_dev_run False --n_channels_in 3 --heatmap_sigma 3 --minimal_keypoint_extraction_pixel_distance 10 \
--n_resnet_blocks 3 --n_downsampling_layers 2 --n_hourglasses 1 --n_hg_blocks 4 --augment_train --loss_function "BCE" --variable_heatmap_sigma 1.2;